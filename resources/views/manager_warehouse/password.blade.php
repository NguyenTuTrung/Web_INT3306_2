        ...
        <div class="col-lg-9 col-md-9 mb-30">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('manager_warehouse.password.update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
...
@push('breadcrumb-plugins')
    <a href="{{route('manager_warehouse.profile')}}" class="btn btn-sm btn--primary box--shadow1 text--small" ><i class="fa fa-user"></i>@lang('Profile Setting')</a>
@endpush
