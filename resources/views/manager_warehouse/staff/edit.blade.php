...
@section('panel')
    <div class="row mb-none-30">
        <div class="col-lg-12 col-md-12 mb-30">
            <div class="card">
                <div class="card-body">
                    <form action="{{route('manager_warehouse.staff.update', encrypt($staff->id))}}" method="POST">
                        @csrf
                        <div class="row">
...
@push('breadcrumb-plugins')
    <a href="{{route('manager_warehouse.staff.index')}}" class="btn btn-sm btn--primary box--shadow1 text--small"><i class="las la-angle-double-left"></i> @lang('Go Back')</a>
@endpush
